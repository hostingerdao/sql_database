...
insert into tindang values('CT00000001',  TO_date('12-08-2015 10:02:30', 'DD/MM/YYYY HH24:MI:SS') , TO_date('12-08-2016 01:02:30', 'DD/MM/YYYY HH24:MI:SS') );
insert into tindang values('CT00000002',  TO_date('12-08-2015 10:02:30', 'DD/MM/YYYY HH24:MI:SS') , TO_date('12-07-2016 01:02:30', 'DD/MM/YYYY HH24:MI:SS') );
insert into tindang values('CT00000002',  TO_date('12-08-2015 10:02:30', 'DD/MM/YYYY HH24:MI:SS') , TO_date('12-06-2016 01:02:30', 'DD/MM/YYYY HH24:MI:SS') );
insert into tindang values('CT00000002',  TO_date('12-08-2015 10:02:30', 'DD/MM/YYYY HH24:MI:SS') , TO_date('12-05-2016 01:02:30', 'DD/MM/YYYY HH24:MI:SS') );
insert into tindang values('CT00000002',  TO_date('12-08-2015 10:02:30', 'DD/MM/YYYY HH24:MI:SS') , TO_date('12-04-2016 01:02:30', 'DD/MM/YYYY HH24:MI:SS') );
insert into tindang values('CT00000002',  TO_date('12-08-2015 10:02:30', 'DD/MM/YYYY HH24:MI:SS') , TO_date('12-03-2016 01:02:30', 'DD/MM/YYYY HH24:MI:SS') );
ALTER SESSION SET NLS_DATE_FORMAT='DD-MM-YYYY';
--7 end ------------------------------------------------------------------------------------------------

--8-----------------------------------------------------------------------------------------------------
insert into KhachHang values('CT00000001','Thong Thi Minh', '1996', '11223344559', 'phan.truong@gmail.com', '01234567890', 'D0001', 'P0001', '');
insert into KhachHang values('CT00000002','Vuong Ba Thinh', '1986', '21223344559', 'ba.vuong@gmail.com', '01234567891', 'D0002', 'P0001', '');
insert into KhachHang values('CT00000003','Hoang Phi Hong', '1976', '31223344559', 'hongphi@gmail.com', '01234567892', 'D0003', 'P0001', '');
insert into KhachHang values('KH00000001','Van Thi Huong', '1976', '41223344559', 'thinh.vuong@gmail.com', '01234567893', 'D0001', 'P0002', '');
insert into KhachHang values('KH00000002','Do Duc Tai', '1976', '51223344559', 'tai.do@gmail.com', '01234567894', 'D0002', 'P0002', '');
insert into KhachHang values('KH00000003','Minh Van Tran', '1966', '61223344559', 'vantran@gmail.com', '01234567895', 'D0003', 'P0002', '');
...
insert into bdsdangban values('CH000002', 'CT00000002', 12000000000, 'Tra gop', 'De biet them thong tin lien he...');
...
insert into ChuongTrinhKM values(2, 'Mung Dang Mung Xuan 2016', 'Chuong trinh co gia tri tren toan quoc', '20-12-2015', '11-02-2016');
insert into ChuongTrinhKM values(3, 'Giai phong hoan toan mien Nam', 'Chuong trinh co gia tri tren toan quoc', '11-03-2016', '11-04-2016');
insert into ChuongTrinhKM values(4, 'Quoc Khanh 2-9', 'Chuong trinh co gia tri tren toan quoc', '01-09-2016', '05-09-2016');
insert into ChuongTrinhKM values(5, 'Quoc te phu nu', 'Chuong trinh co gia tri tren toan quoc', '06-03-2016', '08-03-2016');
insert into ChuongTrinhKM values(6, 'Sinh nhat la thu 10', 'Chuong trinh co gia tri tren toan quoc', '10-10-2016', '13-10-2016');
--15 end ------------------------------------------------------------------------------------------------

--16-----------------------------------------------------------------------------------------------------
insert into BDSKM values(1, 'CH000001', 0);
insert into BDSKM values(1, 'CH000002', 0);
insert into BDSKM values(1, 'DN000002', 0);
insert into BDSKM values(2, 'CH000002', 0);
insert into BDSKM values(2, 'DN000002', 0);
...
insert into ChungCu values('CC0003','Chung cu Ly Thuong Kiet', '2012', '8', 'D0003', 'P0003', 5, 20, 7000000, 3, 6, 'Cong vien, Cho, Nha tap the hinh');
...
--test for trigger 2
insert into GiaoDichThanhCong values('CH000001', 9, '2016','03','28', 12000000, 'Ban' );
update giaodichthanhcong set gia = 1200005 where mabds = 'CH000001';
commit;

delete giaodichthanhcong where mabds = 'CH000001';
...
create or replace 
trigger TRIGGER_GIAODICHTHANHCONG_GIA 
BEFORE INSERT OR UPDATE ON GIAODICHTHANHCONG 
FOR EACH ROW 
declare
gia number(12,0);
BEGIN
